...
const CreateTimer: React.FC<CreateTimerProps> = ({ onTimerCreated }) => {
  ...
  // TODO: Look into React.FormEvent
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault(); // TODO: What does this mean?
  ...
  // TODO: Should this my-5 spacing be made available and referenced able by both this and timer-list?
